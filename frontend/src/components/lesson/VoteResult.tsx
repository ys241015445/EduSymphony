...
import { ROLE_KEY_MAP } from './AgentCard'
  ...
  return (
    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-xs text-brand-600 font-medium">{ROLE_KEY_MAP[acceptedRole] ? t(ROLE_KEY_MAP[acceptedRole]) : acceptedRole}</span>
      </div>
